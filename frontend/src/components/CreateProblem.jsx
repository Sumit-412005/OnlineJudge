      ...
      <main className="max-w-5xl mx-auto px-6 py-10">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-400">
            Add a problem statement, difficulty and test cases.
          </p>
        </div>
        ...
        >
          ...
          <div className="mb-6">
            ...
            <input
              ...
              required
              className="w-full px-4 py-3 rounded-xl bg-slate-800 border border-slate-700 text-white placeholder-slate-500 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition"
            />
          </div>
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              rows={8}
              required
              className="w-full px-4 py-3 rounded-xl bg-slate-800 border border-slate-700 text-white placeholder-slate-500 outline-none resize-y focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition"
            />
          </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">
                  Add the input and expected output for each test case.
                </p>
              </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={4}
                        required
                        className="w-full px-3 py-2.5 rounded-lg bg-slate-900 border border-slate-700 text-white placeholder-slate-600 outline-none resize-y focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition"
                      />
                    </div>
